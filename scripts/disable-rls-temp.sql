-- =====================================================
-- DESABILITAR RLS TEMPORARIAMENTE - SOLUÇÃO RÁPIDA
-- =====================================================

-- Desabilitar RLS em todas as tabelas para resolver o problema de recursão infinita
...
-- Inserir dados iniciais de subjects
...
SELECT 'RLS desabilitado temporariamente. Sistema funcionando!' as status;
